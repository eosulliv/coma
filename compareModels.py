...
facedata = FaceData(nVal=1, train_file=opt.data+'_train.npy', test_file=opt.data+'_test.npy',
					reference_mesh_file=reference_mesh_file, pca_n_comp=int(opt.nz))
...
test_vertices = (np.reshape(
	facedata.vertices_test, (facedata.vertices_test.shape[0], facedata.n_vertex, 3)) * facedata.std) + facedata.mean
