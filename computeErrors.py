...
parser.add_argument('--cnn', default='/is/ps/shared/aranjan/convFaces/results/iclr/bareteeth21_predictions.npy',
...
save_error_plt(cnn=cnn_vertices, pca=pca_vertices, test=test_vertices,
			   fname=opt.save+'/plt/'+os.path.basename(opt.data)+'.png')
...
print('{} PCA Error: {:.3f}+{:.3f} | {:.3f} CoMA Error: {:.3f}+{:.3f} | {:.3f}'.format(
	os.path.basename(opt.data), pca_err, pca_std, pca_med, cnn_err, cnn_std,  cnn_med))
